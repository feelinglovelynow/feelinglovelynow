...
<button class="search__button top brand hide-on-modal-visible box-shadow" on:click={ showModal } title="Click to search">
  { @html SVG_SEARCH }
</button>

<button class="search__button bottom brand hide-on-modal-visible box-shadow" on:click={ showModal } title="Click to search">
  { @html SVG_SEARCH }
</button>
