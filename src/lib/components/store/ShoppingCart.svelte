...
<div class="cart">
  <Modal header="Release Date ⋅ 11/11/23" on:functions={ bindModalFunctions }>
    ...
    <div class="papyrus two shipping-head">Shipping</div>
    <div>
      <div class="form-item">
        <label for="name">Name</label>
        <input bind:value={ name } id="name" name="name" class="brand" type="text">
      </div>

      <div class="form-item">
        <label for="email">Email</label>
        <input bind:value={ email } id="email" name="email" class="brand" type="text">
      </div>

      <div class="form-item">
        <label for="address">Address</label>
        <textarea bind:value={ address } id="address" name="address" class="brand"></textarea>
      </div>

      <div class="form-items form-items--2">
        <div class="form-item">
          <label for="zip">Zip</label>
          <input bind:value={ zip } id="zip" name="zip" class="brand" type="text" >
        </div>

        <div class="form-item">
          <label for="country">Country</label>
          <select bind:value={ country } id="country" name="country" class="brand full-width">
